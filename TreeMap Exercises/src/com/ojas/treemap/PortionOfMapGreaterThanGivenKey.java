...
public class PortionOfMapGreaterThanGivenKey {
	...
	public static void main(String[] args) {
		...
		SortedMap<String, String> keyValue = listOfElements.tailMap("C");
		System.out.println("Portion of map whose keys are greater than or equal to given key ");
